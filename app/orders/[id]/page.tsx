              ...
              <div className="bg-white/20 backdrop-blur-lg rounded-2xl p-6 border border-white/30">
                ...
                <div className="space-y-4">
                  {order.items.map((item) => (
                    <div key={item.id} className="flex justify-between items-center p-4 bg-white/10 rounded-xl">
                      <div>
                        <p className="text-white font-semibold">Product ID: {item.productId}</p>
                        <p className="text-white/70 text-sm">Unit Price: ${formatPrice(item.unitPrice)}</p>
                      </div>
